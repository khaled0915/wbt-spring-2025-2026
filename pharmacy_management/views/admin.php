...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Create, update, search, and remove pharmacist accounts for your pharmacy team.</p>
        </div>
    </div>
    ...
    <?php if (isset($_GET['msg'])): ?>
        <?php $messages = ['added' => 'Pharmacist added successfully.',
                           ...
                           'deleted' => 'Pharmacist removed successfully.'];
              $msg = $messages[$_GET['msg']] ?? null; ?>
        <?php if ($msg): ?><div class="alert alert-success"><?= $msg ?></div><?php endif; ?>
    <?php endif; ?>

    <?php if ($uiError !== ''): ?>
        <div class="alert alert-error"><?= htmlspecialchars($uiError) ?></div>
    <?php endif; ?>
        ...
        <div class="card-toolbar">
            <div class="search-wrap">
                ...
                <input type="text" id="searchInput" class="search-input"
                       placeholder="Search pharmacists by name, username, or contact...">
            </div>
            <span class="badge" id="resultCount"><?= count($librarians) ?> pharmacists</span>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    <?php if (empty($librarians)): ?>
                        <tr><td colspan="5" class="empty">No pharmacist accounts yet.</td></tr>
                    <?php else: ?>
...
(function () {
    ...
    function render(rows) {
        if (!rows.length) {
            body.innerHTML = '<tr><td colspan="5" class="empty">No matching pharmacist accounts.</td></tr>';
        ...
        body.innerHTML = html;
        counter.textContent = input.value.trim() ? (rows.length + ' results') : (rows.length + ' pharmacists');
    }
